...
#ifndef PAGMO_ALGORITHMS_CUSTOM_SGA_HPP
#define PAGMO_ALGORITHMS_CUSTOM_SGA_HPP
...
enum class custom_sga_selection { TOURNAMENT, TRUNCATED };

enum class custom_sga_crossover { EXPONENTIAL, BINOMIAL, SINGLE, SBX };

enum class custom_sga_mutation { GAUSSIAN, UNIFORM, POLYNOMIAL, INDEX_SWAP };
 ...
 * \endverbatim
 */
class PAGMO_DLL_PUBLIC custom_sga
{
public:
     ...
     */
    custom_sga(unsigned gen = 1u, double cr = .90, double eta_c = 1., double m = 0.02, double param_m = 1.,
        unsigned param_s = 2u, std::string crossover = "exponential", std::string mutation = "polynomial",
        std::string selection = "tournament", bool uniqueness=false, bool playfair=false, unsigned seed = pagmo::random_device::next());
    ...
    {
        return "SGA: Genetic Algorithm (customized)";
    }
...
private:
    ...
    bool m_playfair;
    unsigned m_param_s;
    detail::custom_sga_mutation m_mutation;
    detail::custom_sga_selection m_selection;
    detail::custom_sga_crossover m_crossover;
